const cursos = [
    {
      ...
      contenidoHtml: `
<h3>Conceptos básicos de prevención de riesgos</h3>
<ul>
    <li>Introducción a la prevención – Parte 1</li>
    <li>Introducción a la prevención – Parte 2</li>
</ul>

<h3>Prevención de riesgos laborales</h3>
<ul>
    <li>Peligros biológicos</li>
    <li>Peligros ergonómicos</li>
    <li>Factores de riesgo psicosociales</li>
    <li>Peligros físicos</li>
    <li>Peligros químicos</li>
    <li>Riesgos de golpes, cortes y caídas</li>
    <li>Riesgo eléctrico</li>
    <li>Riesgo de incendio y explosión</li>
</ul>

<h2>¿Cómo aprenderás en Capacita-T?</h2>
<p>La plataforma utiliza un modelo educativo flexible y práctico, adaptado a las necesidades de personas con distintos niveles de experiencia. Estos son los pilares de su metodología:</p>
<ul>
    <li>Videolecciones: Clases grabadas por expertos, accesibles en cualquier momento.
    </li>
    <li>Guías</li>
    <li>Ejercicios prácticos</li>
    <li>Cursos asinscronicos disponible las 24 horas</li>
</ul>

<h2>¿Cómo obtener tu certificado?</h2>
<p>La inscripción y certificación son <strong>100% gratuitas</strong>.</p>
<p>Al completar todo el material y aprobar el examen final, podrás <strong>descargar tu certificado</strong> desde la pestaña <strong>"Progreso del curso"</strong>.</p>
<h2>¿Cómo inscribirse en el curso gratis?</h2>
<p>La plataforma CAPACÍTA-T del MTPE está dirigida a los peruanos mayores de 18 años que buscan capacitación pertinente, flexible y de calidad, además de gratuita para mejorar su empleabilidad y perspectivas laborales.<p>
<p><a href="https://capacitacionlaboral.trabajo.gob.pe/cursos/analisis-de-datos-con-power-bi/" target="_blank">INSCRIBETE AQUÍ</a></p>
  ...
  },
  {
    ...
    contenidoHtml: `
<p>
    El curso permite aprender el manejo de cuadros, tablas y gráficos en Excel, aplicables a diversas actividades laborales.
</p>

<h3>Con este curso podrás:</h3>
<ul>
    <li>Elaborar cuadros y tablas</li>
    <li>Trabajar con columnas y filas</li>
    <li>Aplicar las funciones básicas</li>
    <li>Obtener valores de mínimos, máximos y promedio</li>
    <li>Elaborar gráficos</li>
</ul>

<h3>Contenido:</h3>
<ul>
    <li>¿Cómo elaboramos cuadros y tablas?</li>
    <li>¿Cómo trabajar columnas y filas?</li>
    <li>¿Cómo aplicamos las funciones básicas?</li>
    <li>¿Cómo obtenemos mínimo, máximo y promedio?</li>
    <li>¿Cómo elaboramos un gráfico?</li>
    <li>Tips para Microsoft Excel</li>
</ul>
...
{
  id: "70",
  titulo: "Cursos online gratis con certificado del Ministerio de trabajo y promoción del empleo 2025",
  introduccion: "Descubre más de 200 cursos y 50 rutas formativas diseñados para potenciar y fortalecer tus competencias laborales, ¡con certificación gratuita incluida",
